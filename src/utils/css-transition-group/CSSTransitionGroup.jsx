...
import {
  ...
  inChildren,
  inChildrenByKey
} from './TransitionChildMapping.js';
import { CSSTransitionGroupChild } from './CSSTransitionGroupChild.js';
...
export class CSSTransitionGroup extends Component {
  ...
  render(
    ...
    return <Component {...props}>{filterNullChildren(children).map(this.renderChild)}</Component>;
  }
}
